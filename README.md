...
- **Room lists** — anything you add to a room can be renamed or removed on the spot; removing the last one falls back to Classic rather than leaving the room with nothing to draw.
